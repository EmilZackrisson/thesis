...
if [[ $PROTOCOL = "udp" ]]; then
    ...
    $THESIS_REPO_PATH/scripts/run-udp-test.sh "server=10.200.200.1 pktCount=1000 destPort=30002 minIfg=1000 maxIfg=1000000 minSize=10 maxSize=1472 wtDist=u pktDist=u"
