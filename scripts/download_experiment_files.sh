...
### USAGE ###
#
# This scripts downloads, converts and places all measurement data from an experiment into a logical and easy directory tree.
#
# ./download_experiment_files.sh EXPID [UDP|HTTP]
#
# ssh to NodeB MUST be working before running this script
#
### END USAGE ###
...
if [[ "$PROTOCOL" == "UDP" ]]; then
    ...
    echo "Usage: $0 TRACE_DIR [UDP|HTTP]"
    exit 1
fi
